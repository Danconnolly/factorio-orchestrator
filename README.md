...
Install the compatible `factorio-benchmark==0.2.1` and
`factorio-orchestrator==0.2.1` wheels together, or use `uv sync` from this
...
uv build
uv run python scripts/smoke_wheel_metadata.py ../factorio-benchmark/dist/factorio_benchmark-0.2.1-py3-none-any.whl dist/factorio_orchestrator-0.2.1-py3-none-any.whl
```
