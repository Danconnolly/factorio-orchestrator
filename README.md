...
Install the compatible `factorio-benchmark==0.1.4` and
`factorio-orchestrator==0.1.5` wheels together, or use `uv sync` from this
...
uv build
uv run python scripts/smoke_wheel_metadata.py ../factorio-benchmark/dist/factorio_benchmark-0.1.4-py3-none-any.whl dist/factorio_orchestrator-0.1.5-py3-none-any.whl
```
